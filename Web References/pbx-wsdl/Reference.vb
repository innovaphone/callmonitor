...
Namespace pbx_wsdl
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927"),  _
     ...
     System.Xml.Serialization.SoapIncludeAttribute(GetType(Device)),  _
    ...
    Partial Public Class pbx
        ...
        Private DevicesOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Private UserRcOperationCompleted As System.Threading.SendOrPostCallback
        
        Private UserInfoOperationCompleted As System.Threading.SendOrPostCallback
        
        Private UserDTMFOperationCompleted As System.Threading.SendOrPostCallback
        
        Private UserUUIOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Private UserMediaTransferOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Private UserMessageOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.inno.My.MySettings.Default.inno_WebReference_pbx
        ...
        '''<remarks/>
        Public Event DevicesCompleted As DevicesCompletedEventHandler
        ...
        '''<remarks/>
        Public Event UserRcCompleted As UserRcCompletedEventHandler
        
        '''<remarks/>
        Public Event UserInfoCompleted As UserInfoCompletedEventHandler
        
        '''<remarks/>
        Public Event UserDTMFCompleted As UserDTMFCompletedEventHandler
        
        '''<remarks/>
        Public Event UserUUICompleted As UserUUICompletedEventHandler
        ...
        '''<remarks/>
        Public Event UserMediaTransferCompleted As UserMediaTransferCompletedEventHandler
        ...
        '''<remarks/>
        Public Event UserMessageCompleted As UserMessageCompletedEventHandler
        ...
        Public Function Initialize(ByVal user As String, ByVal appl As String, ByVal v As Boolean, ByVal v501 As Boolean, ByVal v700 As Boolean, ByVal v800 As Boolean, ByRef key As Integer) As <System.Xml.Serialization.SoapElementAttribute("return")> Integer
            Dim results() As Object = Me.Invoke("Initialize", New Object() {user, appl, v, v501, v700, v800})
            key = CType(results(1),Integer)
            Return CType(results(0),Integer)
        End Function
        
        '''<remarks/>
        Public Overloads Sub InitializeAsync(ByVal user As String, ByVal appl As String, ByVal v As Boolean, ByVal v501 As Boolean, ByVal v700 As Boolean, ByVal v800 As Boolean)
            Me.InitializeAsync(user, appl, v, v501, v700, v800, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub InitializeAsync(ByVal user As String, ByVal appl As String, ByVal v As Boolean, ByVal v501 As Boolean, ByVal v700 As Boolean, ByVal v800 As Boolean, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("Initialize", New Object() {user, appl, v, v501, v700, v800}, Me.InitializeOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://innovaphone.com/pbx#Devices", RequestNamespace:="http://innovaphone.com/pbx", ResponseNamespace:="http://innovaphone.com/pbx")>  _
        Public Function Devices(ByVal session As Integer, ByVal user As String) As <System.Xml.Serialization.SoapElementAttribute("return")> Device()
            Dim results() As Object = Me.Invoke("Devices", New Object() {session, user})
            Return CType(results(0),Device())
        End Function
        
        '''<remarks/>
        Public Overloads Sub DevicesAsync(ByVal session As Integer, ByVal user As String)
            Me.DevicesAsync(session, user, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub DevicesAsync(ByVal session As Integer, ByVal user As String, ByVal userState As Object)
            If (Me.DevicesOperationCompleted Is Nothing) Then
                Me.DevicesOperationCompleted = AddressOf Me.OnDevicesOperationCompleted
            End If
            Me.InvokeAsync("Devices", New Object() {session, user}, Me.DevicesOperationCompleted, userState)
        End Sub
        
        Private Sub OnDevicesOperationCompleted(ByVal arg As Object)
            If (Not (Me.DevicesCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent DevicesCompleted(Me, New DevicesCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        Public Function UserInitialize(ByVal session As Integer, ByVal user As String, ByVal xfer As Boolean, ByVal disc As Boolean, ByVal hw As String) As <System.Xml.Serialization.SoapElementAttribute("return")> Integer
            Dim results() As Object = Me.Invoke("UserInitialize", New Object() {session, user, xfer, disc, hw})
            Return CType(results(0),Integer)
        End Function
        
        '''<remarks/>
        Public Overloads Sub UserInitializeAsync(ByVal session As Integer, ByVal user As String, ByVal xfer As Boolean, ByVal disc As Boolean, ByVal hw As String)
            Me.UserInitializeAsync(session, user, xfer, disc, hw, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserInitializeAsync(ByVal session As Integer, ByVal user As String, ByVal xfer As Boolean, ByVal disc As Boolean, ByVal hw As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("UserInitialize", New Object() {session, user, xfer, disc, hw}, Me.UserInitializeOperationCompleted, userState)
        End Sub
        ...
        Public Function UserCall(ByVal user As Integer, ByVal cn As String, ByVal e164 As String, ByVal h323 As String, ByVal reg As Integer, ByVal info() As Info, ByVal rc As Integer, ByVal srce164 As String) As <System.Xml.Serialization.SoapElementAttribute("return")> Integer
            Dim results() As Object = Me.Invoke("UserCall", New Object() {user, cn, e164, h323, reg, info, rc, srce164})
            Return CType(results(0),Integer)
        End Function
        
        '''<remarks/>
        Public Overloads Sub UserCallAsync(ByVal user As Integer, ByVal cn As String, ByVal e164 As String, ByVal h323 As String, ByVal reg As Integer, ByVal info() As Info, ByVal rc As Integer, ByVal srce164 As String)
            Me.UserCallAsync(user, cn, e164, h323, reg, info, rc, srce164, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserCallAsync(ByVal user As Integer, ByVal cn As String, ByVal e164 As String, ByVal h323 As String, ByVal reg As Integer, ByVal info() As Info, ByVal rc As Integer, ByVal srce164 As String, ByVal userState As Object)
            If (Me.UserCallOperationCompleted Is Nothing) Then
                Me.UserCallOperationCompleted = AddressOf Me.OnUserCallOperationCompleted
            End If
            Me.InvokeAsync("UserCall", New Object() {user, cn, e164, h323, reg, info, rc, srce164}, Me.UserCallOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://innovaphone.com/pbx#UserRc", RequestNamespace:="http://innovaphone.com/pbx", ResponseNamespace:="http://innovaphone.com/pbx")>  _
        Public Sub UserRc(ByVal [call] As Integer, ByVal rc As Integer)
            Me.Invoke("UserRc", New Object() {[call], rc})
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserRcAsync(ByVal [call] As Integer, ByVal rc As Integer)
            Me.UserRcAsync([call], rc, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserRcAsync(ByVal [call] As Integer, ByVal rc As Integer, ByVal userState As Object)
            If (Me.UserRcOperationCompleted Is Nothing) Then
                Me.UserRcOperationCompleted = AddressOf Me.OnUserRcOperationCompleted
            End If
            Me.InvokeAsync("UserRc", New Object() {[call], rc}, Me.UserRcOperationCompleted, userState)
        End Sub
        
        Private Sub OnUserRcOperationCompleted(ByVal arg As Object)
            If (Not (Me.UserRcCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent UserRcCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://innovaphone.com/pbx#UserInfo", RequestNamespace:="http://innovaphone.com/pbx", ResponseNamespace:="http://innovaphone.com/pbx")>  _
        Public Sub UserInfo(ByVal [call] As Integer, ByVal recv As Boolean, ByVal cdpn As String, ByVal key As String, ByVal dsp As String)
            Me.Invoke("UserInfo", New Object() {[call], recv, cdpn, key, dsp})
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserInfoAsync(ByVal [call] As Integer, ByVal recv As Boolean, ByVal cdpn As String, ByVal key As String, ByVal dsp As String)
            Me.UserInfoAsync([call], recv, cdpn, key, dsp, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserInfoAsync(ByVal [call] As Integer, ByVal recv As Boolean, ByVal cdpn As String, ByVal key As String, ByVal dsp As String, ByVal userState As Object)
            If (Me.UserInfoOperationCompleted Is Nothing) Then
                Me.UserInfoOperationCompleted = AddressOf Me.OnUserInfoOperationCompleted
            End If
            Me.InvokeAsync("UserInfo", New Object() {[call], recv, cdpn, key, dsp}, Me.UserInfoOperationCompleted, userState)
        End Sub
        
        Private Sub OnUserInfoOperationCompleted(ByVal arg As Object)
            If (Not (Me.UserInfoCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent UserInfoCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://innovaphone.com/pbx#UserDTMF", RequestNamespace:="http://innovaphone.com/pbx", ResponseNamespace:="http://innovaphone.com/pbx")>  _
        Public Sub UserDTMF(ByVal [call] As Integer, ByVal recv As Boolean, ByVal dtmf As String)
            Me.Invoke("UserDTMF", New Object() {[call], recv, dtmf})
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserDTMFAsync(ByVal [call] As Integer, ByVal recv As Boolean, ByVal dtmf As String)
            Me.UserDTMFAsync([call], recv, dtmf, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserDTMFAsync(ByVal [call] As Integer, ByVal recv As Boolean, ByVal dtmf As String, ByVal userState As Object)
            If (Me.UserDTMFOperationCompleted Is Nothing) Then
                Me.UserDTMFOperationCompleted = AddressOf Me.OnUserDTMFOperationCompleted
            End If
            Me.InvokeAsync("UserDTMF", New Object() {[call], recv, dtmf}, Me.UserDTMFOperationCompleted, userState)
        End Sub
        
        Private Sub OnUserDTMFOperationCompleted(ByVal arg As Object)
            If (Not (Me.UserDTMFCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent UserDTMFCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://innovaphone.com/pbx#UserUUI", RequestNamespace:="http://innovaphone.com/pbx", ResponseNamespace:="http://innovaphone.com/pbx")>  _
        Public Sub UserUUI(ByVal [call] As Integer, ByVal recv As Boolean, ByVal uui As String)
            Me.Invoke("UserUUI", New Object() {[call], recv, uui})
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserUUIAsync(ByVal [call] As Integer, ByVal recv As Boolean, ByVal uui As String)
            Me.UserUUIAsync([call], recv, uui, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserUUIAsync(ByVal [call] As Integer, ByVal recv As Boolean, ByVal uui As String, ByVal userState As Object)
            If (Me.UserUUIOperationCompleted Is Nothing) Then
                Me.UserUUIOperationCompleted = AddressOf Me.OnUserUUIOperationCompleted
            End If
            Me.InvokeAsync("UserUUI", New Object() {[call], recv, uui}, Me.UserUUIOperationCompleted, userState)
        End Sub
        
        Private Sub OnUserUUIOperationCompleted(ByVal arg As Object)
            If (Not (Me.UserUUICompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent UserUUICompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        Public Function UserRedirect(ByVal [call] As Integer, ByVal cn As String, ByVal e164 As String, ByVal h323 As String, ByVal info() As Info, ByVal rc As Integer) As <System.Xml.Serialization.SoapElementAttribute("return")> Boolean
            Dim results() As Object = Me.Invoke("UserRedirect", New Object() {[call], cn, e164, h323, info, rc})
            Return CType(results(0),Boolean)
        End Function
        
        '''<remarks/>
        Public Overloads Sub UserRedirectAsync(ByVal [call] As Integer, ByVal cn As String, ByVal e164 As String, ByVal h323 As String, ByVal info() As Info, ByVal rc As Integer)
            Me.UserRedirectAsync([call], cn, e164, h323, info, rc, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserRedirectAsync(ByVal [call] As Integer, ByVal cn As String, ByVal e164 As String, ByVal h323 As String, ByVal info() As Info, ByVal rc As Integer, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("UserRedirect", New Object() {[call], cn, e164, h323, info, rc}, Me.UserRedirectOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://innovaphone.com/pbx#UserMediaTransfer", RequestNamespace:="http://innovaphone.com/pbx", ResponseNamespace:="http://innovaphone.com/pbx")>  _
        Public Sub UserMediaTransfer(ByVal a As Integer, ByVal b As Integer, ByVal user As Boolean, ByVal peer As Boolean)
            Me.Invoke("UserMediaTransfer", New Object() {a, b, user, peer})
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserMediaTransferAsync(ByVal a As Integer, ByVal b As Integer, ByVal user As Boolean, ByVal peer As Boolean)
            Me.UserMediaTransferAsync(a, b, user, peer, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserMediaTransferAsync(ByVal a As Integer, ByVal b As Integer, ByVal user As Boolean, ByVal peer As Boolean, ByVal userState As Object)
            If (Me.UserMediaTransferOperationCompleted Is Nothing) Then
                Me.UserMediaTransferOperationCompleted = AddressOf Me.OnUserMediaTransferOperationCompleted
            End If
            Me.InvokeAsync("UserMediaTransfer", New Object() {a, b, user, peer}, Me.UserMediaTransferOperationCompleted, userState)
        End Sub
        
        Private Sub OnUserMediaTransferOperationCompleted(ByVal arg As Object)
            If (Not (Me.UserMediaTransferCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent UserMediaTransferCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("http://innovaphone.com/pbx#UserMessage", RequestNamespace:="http://innovaphone.com/pbx", ResponseNamespace:="http://innovaphone.com/pbx")>  _
        Public Function UserMessage(ByVal user As Integer, ByVal e164 As String, ByVal h323 As String, ByVal msg As String, ByVal src_e164 As String, ByVal src_h323 As String) As <System.Xml.Serialization.SoapElementAttribute("return")> Integer
            Dim results() As Object = Me.Invoke("UserMessage", New Object() {user, e164, h323, msg, src_e164, src_h323})
            Return CType(results(0),Integer)
        End Function
        
        '''<remarks/>
        Public Overloads Sub UserMessageAsync(ByVal user As Integer, ByVal e164 As String, ByVal h323 As String, ByVal msg As String, ByVal src_e164 As String, ByVal src_h323 As String)
            Me.UserMessageAsync(user, e164, h323, msg, src_e164, src_h323, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UserMessageAsync(ByVal user As Integer, ByVal e164 As String, ByVal h323 As String, ByVal msg As String, ByVal src_e164 As String, ByVal src_h323 As String, ByVal userState As Object)
            If (Me.UserMessageOperationCompleted Is Nothing) Then
                Me.UserMessageOperationCompleted = AddressOf Me.OnUserMessageOperationCompleted
            End If
            Me.InvokeAsync("UserMessage", New Object() {user, e164, h323, msg, src_e164, src_h323}, Me.UserMessageOperationCompleted, userState)
        End Sub
        
        Private Sub OnUserMessageOperationCompleted(ByVal arg As Object)
            If (Not (Me.UserMessageCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent UserMessageCompleted(Me, New UserMessageCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        Public Function FindUser(ByVal v501 As String, ByVal v700 As String, ByVal v800 As String, ByVal cn As String, ByVal h323 As String, ByVal e164 As String, ByVal count As Integer, ByVal [next] As Integer) As <System.Xml.Serialization.SoapElementAttribute("return")> UserInfo()
            Dim results() As Object = Me.Invoke("FindUser", New Object() {v501, v700, v800, cn, h323, e164, count, [next]})
            Return CType(results(0),UserInfo())
        End Function
        
        '''<remarks/>
        Public Overloads Sub FindUserAsync(ByVal v501 As String, ByVal v700 As String, ByVal v800 As String, ByVal cn As String, ByVal h323 As String, ByVal e164 As String, ByVal count As Integer, ByVal [next] As Integer)
            Me.FindUserAsync(v501, v700, v800, cn, h323, e164, count, [next], Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub FindUserAsync(ByVal v501 As String, ByVal v700 As String, ByVal v800 As String, ByVal cn As String, ByVal h323 As String, ByVal e164 As String, ByVal count As Integer, ByVal [next] As Integer, ByVal userState As Object)
            If (Me.FindUserOperationCompleted Is Nothing) Then
                Me.FindUserOperationCompleted = AddressOf Me.OnFindUserOperationCompleted
            End If
            Me.InvokeAsync("FindUser", New Object() {v501, v700, v800, cn, h323, e164, count, [next]}, Me.FindUserOperationCompleted, userState)
        End Sub
        ...
        Public Function LocationUrl(ByVal v501 As String, ByVal v700 As String, ByVal v800 As String, ByVal loc As String) As <System.Xml.Serialization.SoapElementAttribute("return")> String
            Dim results() As Object = Me.Invoke("LocationUrl", New Object() {v501, v700, v800, loc})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub LocationUrlAsync(ByVal v501 As String, ByVal v700 As String, ByVal v800 As String, ByVal loc As String)
            Me.LocationUrlAsync(v501, v700, v800, loc, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub LocationUrlAsync(ByVal v501 As String, ByVal v700 As String, ByVal v800 As String, ByVal loc As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("LocationUrl", New Object() {v501, v700, v800, loc}, Me.LocationUrlOperationCompleted, userState)
        End Sub
    ...
    Partial Public Class UserInfo
        ...
        Private presenceField As Presence
        
        Private locField As String
        
        Private nodeField As String
        
        Private nodenumField As String
        
        Private objectField As String
        
        Private cfgField As Boolean
        
        Private cfgFieldSpecified As Boolean
        ...
        '''<remarks/>
        Public Property presence() As Presence
            Get
                Return Me.presenceField
            End Get
            Set
                Me.presenceField = value
            End Set
        End Property
        ...
        '''<remarks/>
        Public Property nodenum() As String
            Get
                Return Me.nodenumField
            End Get
            Set
                Me.nodenumField = value
            End Set
        End Property
        ...
        '''<remarks/>
        Public Property cfg() As Boolean
            Get
                Return Me.cfgField
            End Get
            Set
        ...
        Public Property cfgSpecified() As Boolean
            Get
                Return Me.cfgFieldSpecified
            End Get
            Set
                Me.cfgFieldSpecified = value
            End Set
        End Property
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "2.0.50727.4927"),  _
     ...
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Xml.Serialization.SoapTypeAttribute([Namespace]:="http://innovaphone.com/pbx")>  _
    Partial Public Class Presence
        
        Private statusField As PresenceStatus
        
        Private activityField As PresenceActivity
        
        Private activityFieldSpecified As Boolean
        ...
        '''<remarks/>
        <System.Xml.Serialization.SoapIgnoreAttribute()>  _
        Public Property activitySpecified() As Boolean
            Get
                Return Me.activityFieldSpecified
            End Get
            Set
                Me.activityFieldSpecified = value
            End Set
        End Property
    ...
    Public Enum PresenceActivity
        ...
        '''<remarks/>
        <System.Xml.Serialization.SoapEnumAttribute("in-transit")>  _
        intransit
        
        '''<remarks/>
        <System.Xml.Serialization.SoapEnumAttribute("looking-for-work")>  _
        lookingforwork
        ...
        '''<remarks/>
        <System.Xml.Serialization.SoapEnumAttribute("on-the-phone")>  _
        onthephone
        ...
        '''<remarks/>
        <System.Xml.Serialization.SoapEnumAttribute("permanent-absence")>  _
        permanentabsence
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub DevicesCompletedEventHandler(ByVal sender As Object, ByVal e As DevicesCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class DevicesCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property Result() As Device()
            Get
                Me.RaiseExceptionIfNecessary
                Return CType(Me.results(0),Device())
            End Get
        End Property
    End Class
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub UserRcCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub UserInfoCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub UserDTMFCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub UserUUICompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub UserMediaTransferCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub UserMessageCompletedEventHandler(ByVal sender As Object, ByVal e As UserMessageCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class UserMessageCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
